...
namespace HeroBattle.PathFind
{
    public class PathFinder
    {
        ...
        public PathFinder(SearchParameters searchParameters)
        {
            ...
            InitializeNodes(searchParameters.GetMap());
        ...
        public List<Node> getChildNodes(Point location)
        {
            Node parent = nodes[location.X, location.Y];
        ...
        private void InitializeNodes(Map map)
        {
            ...
            for (int y = 0; y < this.height; y++)
            {
                ...
                {
                    this.nodes[x, y] = new Node(x, y, map.IsWalkable(x, y), this.searchParameters.EndLocation);
                }
            }
        }
